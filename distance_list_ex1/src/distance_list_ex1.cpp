...
int main()
{
  ...
  //
  const Distance::MyDistance distanceList[] = {oneKm, oneDm, oneMeter, oneCm};
#define DLIST_SZ	(sizeof(distanceList)/sizeof(distanceList[0]))
